...
function Registration({ closeModal }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const username =
      formData.firstName + "." + formData.lastName + randomNumber;
      ...
      <form onSubmit={handleSubmit}>
        <div className="formContainer">
          <div className="block">
            ...
            <div>
              <label>
                Total Experience<span className="require">*</span>
              </label>
              <br />
              <input
                type="text"
            ...
            <div>
              <label>
                Notice Period<span className="require">*</span>
              </label>
              <br />
              <select
                name="noticePeriod"
          ...
          <div className="block" style={{ float: "right" }}>
            ...
            <div>
              <label>
                Relevant Experience<span className="require">*</span>
              </label>
              <br />
              <input
                type="text"
            ...
            <div>
              <label>
                Qualification<span className="require">*</span>
              </label>
              <br />
              <select
                name="qualification"
            ...
            <div>
              <label>
                Applied Position<span className="require">*</span>
              </label>
              <br />
              <select
                name="position"
