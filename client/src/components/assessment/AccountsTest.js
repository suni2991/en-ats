...
import AccountsQ from './AccountsQ.js';
import './Quiz.css';
    ...
    const handleVisibilityChange = () => {
      if (document.visibilityState === 'hidden') {
        ...
        Swal.fire({
          ...
          text: "Accounts Test has been Disabled",
          icon: 'error',
  ...
  return (
    <div className="quiz-container">
      <div className='heading-timer'>
       <center><h1 style={{fontSize : "22px"}}>Accounts Test</h1></center><br />
      ...
      {!showResult ? (
        <div>
          ...
          <h1 style={{fontWeight: 'bold', color:'#00B4D2', marginTop:'20px',marginBottom:'10px', wordWrap:'break-word', overflowWrap:'break-word',whiteSpace:'normal'}}>{question}</h1>
          <ul>
        ...
        (
          <div className="click-finish">
            <button className='redirect' onClick={updateaccounts}>
