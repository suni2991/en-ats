...
const VocabularyTest = () => {
  ...
  const updateEnglish = useCallback(() => {
    ...
    const handleVisibilityChange = () => {
      if (document.visibilityState === 'hidden') {
        ...
        Swal.fire({
          ...
          text: "Vocabulary Test has been Disabled",
          icon: 'error',
  ...
  return (
    ...
    <center><h1 style={{fontSize : "22px"}}>Vocabulary Test</h1></center><br />
      {!quizFinished && <LogoutTimer initialTimer={300}  />}
      </div>
      ...
      {!showResult ? (
        ...
        (
          <div className="click-finish">
            <button className='redirect' onClick={updateEnglish}>
