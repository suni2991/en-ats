...
const imageFilter = (req, file, cb) => {
  ...
  if (fileExtension === ".png" || fileExtension === ".jpg" || fileExtension === ".jpeg") {
    ...
    cb(new Error("file format not supported. Supported file types are png, jpg, jpeg"), false);
  }
};
...
const fileFilter = (req, file, cb) => {
  let filename = file.originalname;
  let fileExtension = filename.slice(filename.lastIndexOf("."), filename.length);
  if (fileExtension === ".pdf" || fileExtension === ".doc" || fileExtension === ".txt") {
    cb(null, true);
  } else {
    cb(new Error("file format not supported. Supported file types are pdf, doc, txt"), false);
  }
};
